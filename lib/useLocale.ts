...
import { DEFAULT_LOCALE, isSupportedLocale, resolvePreferredLocale } from './locales'
...
// Shared locale state for both worlds (pro and pixel), so switching between
// routes preserves the visitor's language choice via the same localStorage key.
