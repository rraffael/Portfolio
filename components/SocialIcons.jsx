// Inline SVG social icons for the professional world (crisp at any size, no
// external requests). Decorative by default (aria-hidden) — callers pair them
// with a visible text label (as SectionContactPro / FooterPro will).
